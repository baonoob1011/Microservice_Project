...
public enum ErrorCode {
    ...
    LOGIN_FAILED(1012, "Login failed: invalid username or password", HttpStatus.UNAUTHORIZED),
    HET_SAN_PHAM(1012, "The product does not meet your requirements.", HttpStatus.UNAUTHORIZED),
